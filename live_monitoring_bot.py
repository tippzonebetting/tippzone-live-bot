...
class LiveMonitoringBot:
    ...
    def get_live_matches(self) -> List[Dict]:
        """Get live matches from SportMonks API with retry logic"""
        try:
            ...
            # QUICK FIX 4: HTTP timeout + retry protection
            for attempt in range(2):
                try:
                    ...
                    logger.warning(f"API hiba, újrapróbálkozás ({attempt + 1}/2): {e}")
                    if attempt == 0:
                        time.sleep(0.5)
                    else:
                        raise
    ...
    def extract_events(self, match: Dict) -> List[Dict]:
        """Extract match events with enhanced team identification"""
        ...
        for event in events:
            ...
            # QUICK FIX 3: Log "Ismeretlen" team cases for diagnostics
        ...
        while True:
            try:
                ...
                for match in filtered_matches:
                    ...
                    # QUICK FIX 1: Statistics temporarily disabled for speed
                    # stats = self.extract_statistics(match)   # ideiglenesen off
                    current_data = {
                        'home_score': home_score,
                        'away_score': away_score,
                        # **stats    # ideiglenesen off
                    }
    ...
    async def start(self):
        ...
        # QUICK FIX 2: Fail-fast token validation
        ...
        # QUICK FIX 5: Diagnostic logging at startup
